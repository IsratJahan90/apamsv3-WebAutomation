...
public class PageOpen extends New {
	...
	@Test(priority = 4)
	public void apa_management() throws InterruptedException {
		...
		WebElement fiscal = driver
				.findElement(By.xpath("//body/div[3]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/select[1]/option[2]"));
		fiscal.click();
		Thread.sleep(2000);

		WebElement achieve_year = driver
				.findElement(By.xpath("//body/div[3]/div[1]/div[1]/form[1]/div[1]/div[1]/div[2]/select[1]/option[2]"));
		achieve_year.click();
		Thread.sleep(2000);

		WebElement layer = driver
				.findElement(By.xpath("//body/div[3]/div[1]/div[1]/form[1]/div[1]/div[1]/div[3]/select[1]/option[3]"));
		layer.click();
		Thread.sleep(2000);

		WebElement drop3 = driver.findElement(
				By.xpath("//body/div[3]/div[1]/div[1]/form[1]/div[1]/div[1]/div[4]/div[1]/div[2]/input[6]"));
		drop3.click();
		Thread.sleep(5000);
